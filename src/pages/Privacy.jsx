  ...
  return (
    <div className="min-h-screen bg-[#080A0F] text-white font-sans">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-neutral-500 text-sm mb-4">Last updated: 22 April 2026</p>
        <p className="text-neutral-400 text-sm mb-10">This Privacy Policy is issued in compliance with the <strong className="text-white">Data Protection and Privacy Act, 2019</strong> of Uganda (&quot;DPPA&quot;) and the regulations made thereunder.</p>
        ...
        <div className="space-y-8 text-neutral-300 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-white text-lg font-bold mb-3">2. Personal Data We Collect</h2>
            <p className="mb-3">We collect the following categories of personal data:</p>

            <h3 className="text-white text-sm font-bold mb-2">2.1 Data You Provide (Registration &amp; Profile)</h3>
            ...
            <h3 className="text-white text-sm font-bold mb-2">2.2 Geolocation Data</h3>
            <ul className="list-disc pl-5 space-y-1 mb-4">
              <li><strong className="text-white">User location</strong> — real-time GPS coordinates collected via browser Geolocation API (with your explicit consent) to display your position on the map and calculate distances.</li>
              <li><strong className="text-white">Business location</strong> — latitude and longitude pinned by Business Owners to mark their physical location on the map.</li>
            </ul>

            <h3 className="text-white text-sm font-bold mb-2">2.3 Transaction Data</h3>
            <ul className="list-disc pl-5 space-y-1 mb-4">
              <li>Subscription payment amounts, dates, payment methods, and Pesapal reference IDs.</li>
              <li>We do <strong className="text-white">not</strong> store credit/debit card numbers or Mobile Money PINs — these are processed entirely by Pesapal.</li>
            </ul>

            <h3 className="text-white text-sm font-bold mb-2">2.4 Usage &amp; Technical Data</h3>
            <ul className="list-disc pl-5 space-y-1 mb-4">
            ...
            <h3 className="text-white text-sm font-bold mb-2">2.5 Data from Third Parties</h3>
          ...
          <section>
            <h2 className="text-white text-lg font-bold mb-3">3. Legal Basis for Processing (DPPA Section 3)</h2>
          ...
          <section>
            <h2 className="text-white text-lg font-bold mb-3">4. How We Use Your Data</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="text-white text-lg font-bold mb-3">5. Data Sharing &amp; Disclosure</h2>
            <p className="mb-3">We do <strong className="text-white">not sell</strong> your personal data. We share data only with:</p>
            <ul className="list-disc pl-5 space-y-2">
              <li><strong className="text-white">Pesapal Limited</strong> — payment processing (amount, business ID, email). Pesapal is a data processor under the DPPA.</li>
              <li><strong className="text-white">InsForge</strong> — our backend infrastructure provider (database, authentication, storage). Data is processed under a data processing agreement.</li>
              <li><strong className="text-white">CartoDB / OpenStreetMap</strong> — map tile rendering (no personal data shared, only tile coordinates).</li>
              <li><strong className="text-white">OSRM Project</strong> — routing (GPS coordinates for route calculation, no personal identifiers).</li>
              <li><strong className="text-white">Law enforcement or regulatory authorities</strong> — when required by Ugandan law, court order, or to protect rights and safety.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-white text-lg font-bold mb-3">6. Cross-Border Data Transfers</h2>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li><strong className="text-white">Account data</strong> — retained for the duration of your account plus 12 months after closure.</li>
              <li><strong className="text-white">Transaction records</strong> — retained for 7 years as required by Uganda Revenue Authority tax regulations.</li>
              <li><strong className="text-white">Geolocation data (Users)</strong> — processed in real-time only; not stored persistently.</li>
              <li><strong className="text-white">Business GPS coordinates</strong> — retained while the account is active.</li>
              <li><strong className="text-white">Server logs</strong> — retained for up to 90 days.</li>
              <li><strong className="text-white">Uploaded media</strong> — deleted within 30 days of account closure.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-white text-lg font-bold mb-3">8. Your Rights Under the DPPA</h2>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong className="text-white">Rectification</strong> — correct inaccurate or incomplete data (via your Dashboard or by contacting us).</li>
          ...
          <section>
            <h2 className="text-white text-lg font-bold mb-3">9. Data Security</h2>
            <ul className="list-disc pl-5 space-y-1">
              <li>All data in transit is encrypted using <strong className="text-white">TLS 1.2+</strong>.</li>
          ...
          <section>
            <h2 className="text-white text-lg font-bold mb-3">10. Cookies &amp; Local Storage</h2>
          ...
          <section>
            <h2 className="text-white text-lg font-bold mb-3">12. Changes to This Policy</h2>
            <p>We may update this Privacy Policy from time to time. Material changes will be communicated via email or in-app notification at least <strong className="text-white">14 days</strong> before taking effect. The &quot;Last updated&quot; date at the top reflects the most recent revision.</p>
          </section>
